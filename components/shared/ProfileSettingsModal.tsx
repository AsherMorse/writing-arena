        ...
        <div className="max-h-[60vh] overflow-y-auto p-6 space-y-6">
          <div>
            ...
            <input
              ...
              className="w-full rounded-[10px] border border-[rgba(255,255,255,0.05)] bg-[rgba(255,255,255,0.025)] px-4 py-3 font-mono text-sm text-[rgba(255,255,255,0.8)] outline-none transition-colors placeholder:text-[rgba(255,255,255,0.22)] focus:border-[#00e5e5]"
              maxLength={30}
            />
            <p className="mt-2 text-xs text-[rgba(255,255,255,0.22)]">Max 30 characters</p>
          </div>
