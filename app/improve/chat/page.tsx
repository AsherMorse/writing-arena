/**
 * @fileoverview AI chat interface for improving writing based on past matches.
 */
...
export default function ImproveChatPage() {
  return (
    <RequireAuth>
      <ImproveChatPageContent />
    </RequireAuth>
  );
}

/**
 * @description Chat interface for personalized writing improvement.
 */
function ImproveChatPageContent() {
  const { user } = useAuth();
