...
import { getParchmentTextStyle, getParchmentContainerStyle, PaperTexture } from '../_components/parchment-styles';
            ...
            {!error && submissions.length === 0 && (
              <ParchmentCard>
                <div className="text-center py-8">
                  ...
                  <ParchmentButton
                    onClick={() => router.push('/fantasy/ranked')}
                    variant="golden"
                  >
                    Start a Challenge
                  </ParchmentButton>
