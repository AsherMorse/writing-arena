...
import { FantasyReviewPhase } from '@/app/_components/FantasyReviewPhase';
import { SPOEditor, SPOData, createEmptySPO, spoToText, countSPOWords } from '@/app/_components/editors/SPOEditor';
import { PTOEditor, PTOData, createEmptyPTO, ptoToText, countPTOWords } from '@/app/_components/editors/PTOEditor';
...
export default function SessionPage({ params }: SessionPageProps) {
  ...
  async function handleSubmitSession() {
    ...
    try {
      ...
      router.push(`/study/${lessonId}/results`);
    } catch (err) {
